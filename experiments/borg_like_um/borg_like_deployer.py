...
from scheduler.baselines import BORG_LIKE_NAME, BorgLikeScheduler


class BorgLikeDeployer(BaseDeployer):
    def __init__(
        self,
        namespace: str,
        pod_spec: PodSpec,
    ...
    def prepare_under_test_yaml(
        ...
        under_test.base_yaml_preparation(
            ...
            "spec.template.spec.schedulerName", BORG_LIKE_NAME
        ).update(
