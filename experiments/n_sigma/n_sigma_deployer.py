...
from scheduler.baselines import N_SIGMA_NAME, NSigmaScheduler


class NSigmaDeployer(BaseDeployer):
    def __init__(
        self,
        namespace: str,
        pod_spec: PodSpec,
    ...
    def prepare_under_test_yaml(
        ...
        under_test.base_yaml_preparation(
            ...
            "spec.template.spec.schedulerName", N_SIGMA_NAME
        ).update(
