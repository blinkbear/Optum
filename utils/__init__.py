...
node_ip_mapping = k8s_client.get_all_node_ip()
T = TypeVar("T")
...
def get_cpu_capacity(node: str) -> CPUCores:
    return k8s_client.get_cpu_capacity(node)


def get_mem_capacity(node: str) -> MemInMB:
    return k8s_client.get_mem_capacity(node)
